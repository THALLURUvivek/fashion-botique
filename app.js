...
const products = [
    ...
    { id: 9, name: "Quilted Puffer Jacket", brand: "Nordic Co.", category: "outerwear", price: 320, originalPrice: 400, discount: 20, image: "https://images.unsplash.com/photo-1551537482-f2075a1d41f2?w=600&q=80", images: ["https://images.unsplash.com/photo-1551537482-f2075a1d41f2?w=800&q=80"], badge: "sale", rating: 4.6, reviews: 213, colors: ["#000000", "#1a1a2e", "#8B0000"], sizes: ["S", "M", "L", "XL"], description: "Insulated quilted jacket with a sleek silhouette.", isNew: false, isHot: false },
    ...
    { id: 11, name: "Embroidered Cocktail Dress", brand: "LUXE Original", category: "dress", price: 425, originalPrice: 520, discount: 18, image: "https://images.unsplash.com/photo-1496747611176-843222e1e57c?w=600&q=80", images: ["https://images.unsplash.com/photo-1496747611176-843222e1e57c?w=800&q=80"], badge: "sale", rating: 4.9, reviews: 38, colors: ["#1a1a2e", "#800020"], sizes: ["XS", "S", "M", "L"], description: "Hand-embroidered cocktail dress with intricate floral motifs.", isNew: false, isHot: true },
    { id: 12, name: "Merino Wool Cardigan", brand: "Nordic Co.", category: "top", price: 175, originalPrice: null, discount: 0, image: "https://images.unsplash.com/photo-1610288311735-39b7facbd095?w=600&q=80", images: ["https://images.unsplash.com/photo-1610288311735-39b7facbd095?w=800&q=80"], badge: "new", rating: 4.5, reviews: 67, colors: ["#F5F5DC", "#808080", "#000000"], sizes: ["S", "M", "L", "XL"], description: "Luxuriously soft merino cardigan with ribbed trim.", isNew: true, isHot: false }
];
...
// ---- Mobile Menu ----
// Bootstrap offcanvas handles mobile menu via data-bs-toggle attributes
// Sync hamburger animation with Bootstrap offcanvas events
const mobileNavEl = document.getElementById('mobileNavOffcanvas');
const menuToggle = document.getElementById('menuToggle');
if (mobileNavEl && menuToggle) {
    mobileNavEl.addEventListener('show.bs.offcanvas', () => menuToggle.classList.add('active'));
    mobileNavEl.addEventListener('hide.bs.offcanvas', () => menuToggle.classList.remove('active'));
}
...
function renderNewArrivals() {
    ...
    const newItems = products.filter(p => p.isNew || p.discount > 0).slice(0, 4);
...
// ---- Sidebar Functions (Bootstrap Offcanvas) ----
...
function closeWishlistOffcanvas() {
    const el = document.getElementById('wishlistOffcanvas');
    if (el) {
        const bsOffcanvas = bootstrap.Offcanvas.getInstance(el);
        if (bsOffcanvas) bsOffcanvas.hide();
...
if (checkoutBtn) {
    checkoutBtn.addEventListener('click', () => {
        ...
        if (total === 0) {
            ...
            saveCart();
            updateCartUI();
            setTimeout(() => closeCartOffcanvas(), 1500);
        }
    });
}
