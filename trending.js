...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const products = [
        ...
        { id: 11, name: "Embroidered Cocktail Dress", brand: "LUXE Original", category: "dress", price: 425, originalPrice: 520, discount: 18, image: "https://images.unsplash.com/photo-1496747611176-843222e1e57c?w=600&q=80", badge: "hot", rating: 4.9, reviews: 38, colors: ["#1a1a2e", "#800020"], sizes: ["XS", "S", "M", "L"], description: "Hand-embroidered cocktail dress with intricate floral motifs." },
        ...
        { id: 9, name: "Quilted Puffer Jacket", brand: "Nordic Co.", category: "outerwear", price: 320, originalPrice: 400, discount: 20, image: "https://images.unsplash.com/photo-1551537482-f2075a1d41f2?w=600&q=80", badge: "rising", rating: 4.6, reviews: 213, colors: ["#000000", "#1a1a2e"], sizes: ["S", "M", "L", "XL"], description: "Insulated quilted jacket with a sleek silhouette." }
    ];
